...
const resourceList = [{
  ...
  },
  {
    ...
    journalMessage: 'Since you need to work on your CV, this website might be helpful: \n\n https://www.myworldofwork.co.uk/getting-job/building-cv \n\n You need to register, and after that it will guide you through making a new CV.',
  ...
  },
  {
    ...
    summary: 'A collection of guidance and tools that can help with finding work, including a skills check and CV builder. The focus is on Scotland, but many features can be used in the rest of the country.',
    journalMessage: 'My World of Work is a website with tools that can help you find work: \n\n https://www.myworldofwork.co.uk/ \n\n It has a skills check, a CV builder, tips on interviews, and a lot more that could be useful for you.',
    category: ['CV and resumes', 'skills', 'training', 'internships', 'volunteering',
      'apprenticeships', 'work experience', 'interviews', 'CVs, cover letters and interviews',
  ...
  },
  {
    ...
    category: ['CV and resumes', 'interviews', 'networking', 'research', 'work search',
      'social media', 'CVs, cover letters and interviews', 'preparing for work'],
  ...
  },
  {
    ...
    summary: 'Training courses that lead to basic maths and English qualifications – course information and where to find the nearest Learndirect centre.',
    journalMessage: 'Getting a basic maths or English qualification will help to improve your CV and your chances of getting work. Learndirect have free courses: \n\n http://www.learndirect.com/help/about-learndirect/our-products-and-services/qualifications/maths-and-english-courses/ \n\n You can arrange to start the course yourself or we can talk next time we meet.',
  ...
  },
  {
    ...
    groups: ['intensive work search'],
    sector: {
      6122: 'Childminders and related occupations', 612: 'Childcare and Related Personal Services',
    },
  },
  {
    resourceId: 'octo018',
  ...
  },
  {
    ...
    summary: 'Interview tips for applying to be a teaching assistant.',
    journalMessage: "If you're applying for a teaching assistant job, you should prepare for the interview. There are some tips here: \n\n https://www.tes.com/jobs/careers-advice/latest-advice/teaching-assistant-job-interview-advice \n\n ",
  ...
  },
  {
    ...
    summary: 'A collection of useful links about getting a job in school facilities - for example, as a librarian, caretaker or technician.',
    journalMessage: 'This collection of links is a good place to get started if you want a non-teaching job at a school. You can find out about different kinds of support work: \n\n https://www.tes.com/articles/how-get-a-job-school-facilities \n\n',
    category: ['research', 'work search', 'searching for work'],
    groups: ['intensive work search'],
  ...
  },
  {
    ...
    category: ['apprenticeships', 'training', 'research', 'preparing for work',
      'skills, training and qualifications'],
    groups: ['intensive work search', 'young jobseekers'],
    sector: { 2121: 'civil engineers', 8124: 'energy plant operatives' },
  },
  ...
  },
  {
    ...
    summary: 'An NHS careers site with interactive elements, such as quizzes to find suitable roles. It also has real stories from NHS staff and videos.',
    journalMessage: "This is a good place to start if you're thinking about a career in health: \n\nhttps://www.stepintothenhs.nhs.uk\n\n It can help you find a role that might suit you, and the best way in.",
    category: ['apprenticeships', 'work experience', 'qualifications', 'training', 'research',
      'preparing for work', 'skills, training and qualifications'],
    groups: ['intensive work search', 'young jobseekers'],
    sector: { 32: 'health and social care associate professionals' },
  },
  {
  ...
  },
  {
    ...
    category: ['research', 'regulations', 'preparing for work', 'other support',
      'skills, training and qualifications'],
    groups: ['intensive work search', 'self employed'],
    sector: { 6122: 'childminders and related occupations' },
  },
  ...
  },
  {
    ...
    category: ['apprenticeships', 'qualifications', 'training', 'listings', 'searching for work',
      'skills, training and qualifications'],
    groups: ['intensive work search'],
    sector: {
      116: 'managers and directors in transport and logistics',
  ...
  {
    resourceId: 'octo064',
    title: 'Army: role finder',
    url: 'https://www.army.mod.uk/rolefinder/',
    summary: 'Roles available in the British Army - details of duties, pay, qualifications, and more.',
    journalMessage: 'This will give you an idea of roles in the British Army, and which ones might suit your interests: \n\n https://www.army.mod.uk/rolefinder/ \n\n For each role, there are details of duties, pay, the qualifications you could earn, and more.',
    category: ['research', 'skills, training and qualifications', 'training', 'searching for work'],
    groups: ['intensive work search'],
    sector: {
  ...
  },
  {
    ...
    category: ['research', 'mentoring', 'preparing for work', 'other support'],
    groups: ['self employed'],
    sector: {},
  },
  {
  ...
  },
  {
    ...
    summary: 'Advice on preparing for interviews, including competency-based interviews, with tips on research, dress and attitude. It includes a video tool that shows common and tricky interview questions.',
  ...
  },
  {
    ...
    category: ['training', 'preparing for work', 'self-employment',
      'skills, training and qualifications'],
    groups: ['young jobseekers', 'intensive work search'],
    sector: {},
  },
  ...
  },
  {
    ...
    keywords: ['anxiety', 'depression', 'disability'],
    groups: ['intensive work search'],
    sector: {},
  },
  {
    resourceId: 'octo091',
    title: 'The Money Advice Service: Money Manager',
    url: 'https://www.moneyadviceservice.org.uk/en/tools/money-manager',
    summary: 'A budgeting tool specifically for Universal Credit. It asks questions and offers tailored money-management advice based on answers.',
  ...
  },
  {
    ...
    category: ['preparing for work', 'other support', 'health, mental health and wellbeing'],
    groups: [''],
    sector: {},
  },
  {
  ...
  },
  {
    ...
    category: ['other support', 'preparing for work', 'skills, training and qualifications'],
    groups: [''],
    sector: {},
  },
  {
  ...
  },
  {
    ...
    category: ['work search', 'research', 'apprenticeships', 'internships', 'graduate jobs',
      'skills, training and qualifications'],
    groups: ['intensive work search', 'young jobseekers'],
    sector: {},
  },
  {
    ...
    category: ['work search', 'research', 'listings', 'searching for work', 'engineering jobs',
      'science jobs', 'STEM jobs'],
    groups: ['intensive work search', 'young jobseekers'],
    sector: {},
  },
  {
  ...
  },
  {
    ...
    category: ['work search', 'research', 'listings', 'searching for work', 'office jobs'],
    groups: ['intensive work search'],
    sector: {},
  },
  {
    ...
    category: ['work search', 'research', 'listings', 'searching for work', 'science jobs'],
    groups: ['intensive work search'],
    sector: {},
  },
  {
    ...
    category: ['work search', 'research', 'listings', 'searching for work'],
    groups: ['intensive work search'],
    sector: {},
  },
  {
  ...
  },
  {
    ...
    category: ['work search', 'research', 'listings', 'searching for work', 'aviation jobs'],
    groups: ['intensive work search'],
    sector: {},
  },
  {
  ...
  },
  {
    ...
    category: ['research', 'volunteering', 'other support'],
    groups: ['intensive work search', 'young jobseekers'],
    sector: {},
  },
  {
    ...
    category: ['work search', 'research', 'listings', 'searching for work', 'creative jobs'],
    groups: ['intensive work search'],
    sector: {},
  },
  {
    ...
    category: ['work search', 'research', 'listings', 'searching for work', 'gaming jobs',
      'technology jobs'],
    groups: ['intensive work search'],
    sector: {},
  },
  ...
  },
  {
    ...
    category: ['work search', 'research', 'listings', 'searching for work', 'apprenticeships'],
    groups: ['intensive work search'],
    sector: {},
  },
  {
  ...
  },
  {
    ...
    url: 'https://nodesiretoretire.com',
    summary: 'A job search website aimed at people over the age of 50.',
    journalMessage: 'Here\'s a website you might find useful - it lists jobs aimed at people over the age of 50 looking for work:\n\nhttps://www.nodesiretoretire.com\n\nYou need to register by creating a profile about yourself for employers to look at. After that, you can apply for roles that interest you.',
    category: ['searching for work', 'work search', 'research', 'other support'],
    groups: [''],
    sector: {},
  },
  {
  ...
  },
  {
    ...
    category: ['searching for work', 'work search', 'research', 'apprenticeships'],
    groups: [''],
    sector: {},
  },
  {
    ...
    category: ['health, mental health and wellbeing', 'preparing for work', 'other support',
      'research'],
    keywords: ['anxiety', 'depression'],
    groups: [''],
    sector: {},
  ...
  },
  {
    ...
    category: ['skills, training and qualifications', 'apprenticeships', 'research'],
    groups: [''],
    sector: {},
  },
  {
  ...
  {
    resourceId: 'octo153',
    title: 'BBC Careers: trainee schemes and apprenticeships',
    url: 'http://www.bbc.co.uk/careers/trainee-schemes-and-apprenticeships',
    summary: 'Information on trainee schemes and apprenticeships at the BBC - a public service broadcaster on television, on radio and online.',
    journalMessage: 'This will give you an idea of trainee schemes and apprenticeships you could do at the BBC:\n\nhttp://www.bbc.co.uk/careers/trainee-schemes-and-apprenticeships\n\nLook around so you understand your options.',
    category: ['searching for work', 'work search', 'research', 'apprenticeships'],
    groups: [''],
    sector: {},
  },
  {
    resourceId: 'octo154',
    title: 'Monster Jobs: CV templates',
    url: 'https://www.monster.co.uk/career-advice/cv-writing-job-application/free-cv-templates',
    summary: 'Templates for creating CVs.',
    journalMessage: 'This website can help you work on your CV:\n\nhttps://www.monster.co.uk/career-advice/cv-writing-job-application/free-cv-templates\n\nIt has CV templates.',
    category: ['CVs, cover letters and interviews', 'work search', 'research'],
    groups: [''],
    sector: {},
  },
  {
    ...
    summary: 'A set of quizzes and activities to help explore skills, interests and motivations.',
    journalMessage: 'To explore your skills and interests, take a look Skills Health Check. It\'s a set of quizzes and activities that can help you decide what kind of job might be right for you:\n\nhttps://nationalcareersservice.direct.gov.uk/skills-health-check/home',
  ...
  {
    resourceId: 'octo156',
    title: 'The PopUp Business School',
    url: 'https://www.popupbusinessschool.co.uk',
    summary: 'A business school that runs events to help people start small businesses – information, coaching, workshops, peer support, and more.',
  ...
  {
    resourceId: 'octo158',
    title: 'CITB (Construction Industry Training Board): The Construction Training Directory',
    url: 'https://www.citb.co.uk/training-and-courses/construction-training-directory',
    summary: 'A directory of training provided by CITB Approved Training Organisations (ATO).',
  ...
  {
    resourceId: 'octo159',
    title: 'The Money Advice Service: Fee-free basic bank accounts',
    url: 'https://www.moneyadviceservice.org.uk/en/articles/basic-bank-accounts#how-to-get-a-basic-bank-account',
    summary: 'A guide on how to get a fee-free basic bank account.',
  ...
  },
  {
    resourceId: 'octo160',
    title: 'Learn My Way',
    url: 'https://www.learnmyway.com',
    summary: 'A website with free online courses for improving digital skills. It\'s aimed at beginners.',
