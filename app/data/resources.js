...
const resourceList = [
  {
    ...
    category: ['mentoring', 'training', 'Preparing for work', 'Young Jobseekers'],
  ...
  },
  {
    ...
    category: ['internships', 'Young Jobseekers'],
    groups: ['young jobseekers', 'intensive work search'],
    sector: {},
  },
  {
    ...
    category: ['internships', 'volunteering', 'apprenticeships', 'work experience', 'Young Jobseekers'],
    groups: ['young jobseekers', 'intensive work search'],
    sector: {},
  },
  {
    ...
    category: ['CV and resumes', 'skills', 'training', 'internships', 'volunteering', 'apprenticeships', 'work experience', 'interviews', 'CVs and interviews', 'Skills and training', 'Young Jobseekers'],
    groups: ['young jobseekers', 'intensive work search'],
    sector: {},
  },

  {
    ...
    journalMessage: 'We said that more preparation might help you in applications and interviews. To find out more about an employer, search for them on Glassdoor:  \n\n https://www.glassdoor.co.uk/index.htm \n\n The site has company profiles, reviews from employees and ex-employees, and typical interview questions.',
    category: ['CV and resumes', 'interviews', 'research', 'work search', 'Finding out about work', 'CVs and interviews'],
    groups: ['intensive work search'],
    sector: {},
  },
  {
  ...
  },
  {
    ...
    category: ['research', 'work search', 'agencies', 'regulations', 'Finding out about work'],
    groups: ['intensive work search'],
    sector: {},
  },
  {
    ...
    category: ['CV and resumes', 'interviews', 'networking', 'research', 'work search', 'social media', 'CVs and interviews'],
  ...
  },
  {
    ...
    category: ['CV and resumes', 'skills', 'interviews', 'research', 'work search', 'CVs and interviews', 'Skills and training', 'Preparing for work'],
    groups: ['intensive work search'],
    sector: {},
  },
  {
    ...
    category: ['skills', 'Skills and training'],
    groups: ['intensive work search'],
    sector: {},
  },
  {
  ...
  },
  {
    ...
    category: ['research', 'work search', 'qualifications', 'Skills and training'],
    groups: ['intensive work search'],
    sector: {
  ...
  },
  {
    ...
    summary: 'Interview tips for for claimants applying to be a teaching assistant.',
  ...
  },
  {
    ...
    category: ['apprenticeships', 'qualifications', 'training', 'research', 'Finding out about work', 'Young Jobseekers', 'Skills and training'],
    groups: ['intensive work search', 'young jobseekers'],
    sector: {},
  },
  {
  ...
  },
  {
    ...
    category: ['apprenticeships', 'work experience', 'qualifications', 'training', 'research', 'Finding out about work', 'Young Jobseekers', 'Skills and training'],
    groups: ['intensive work search', 'young jobseekers'],
    sector: {},
  },
  {
  ...
  },
  {
    ...
    category: ['work search', 'research', 'apprenticeships', 'qualifications', 'training', 'Finding out about work', 'Young Jobseekers', 'Skills and training'],
    groups: ['intensive work search', 'young jobseekers'],
    sector: {},
  },
  {
    ...
    url: 'http://jobfinder.renewableuk.com/',
    summary: 'Job listings in the construction sector.',
...

  {
    ...
    summary: 'Job listings in the construction sector, with some additional tools, such as a CV check.',
  ...
  },
  {
    ...
    category: ['work search', 'research', 'qualifications', 'Finding out about work', 'Skills and training'],
    groups: ['intensive work search'],
    sector: {},
  },
  {
  ...
  },
  {
    ...
    category: ['apprenticeships', 'work experience', 'training', 'skills', 'Young Jobseekers', 'Skills and training'],
    groups: ['young jobseekers', 'intensive work search'],
    sector: {},
  },
  {
  ...
  },
  {
    ...
    category: ['apprenticeships', 'qualifications', 'training', 'listings', 'Looking for work', 'Young Jobseekers', 'Skills and training'],
    groups: ['intensive work search'],
    sector: {},
  },
  {
    ...
    summary: 'Job listings in the logistics sector.',
  ...
  },
  {
    ...
    summary: "The Skills Funding Agency's basic guidance on logistics operations apprenticeships. Also has a link to apply.",
...

  {
    ...
    category: ['skills', 'training', 'Skills and training', 'Preparing for work'],
  ...
  },
  {
    ...
    journalMessage: 'We talked about becoming an apprentice. The best place to start finding out about apprenticeships is this guide: \n\n https://www.gov.uk/apprenticeships-guide \n\n',
    category: ['apprenticeships', 'qualifications', 'training', 'research', 'Finding out about work', 'Young Jobseekers'],
    groups: ['intensive work search', 'young jobseekers'],
    sector: {},
  },
  {
    ...
    category: ['looking for work', 'research', 'Finding out about work'],
    groups: ['intensive work search'],
    sector: {},
  },
  {
    ...
    journalMessage: "If you think you've seen a scam when you're looking for work online, visit: https://www.safer-jobs.com \n\n It has a lot of guidance and you can report incidents. ",
    category: ['looking for work', 'research', 'Finding out about work'],
    groups: ['intensive work search'],
    sector: {},
  },
  {
    ...
    category: ['research', 'Finding out about work', 'Preparing for work'],
    groups: ['self employed'],
    sector: {},
  },
  {
    ...
    category: ['research', 'Finding out about work'],
    groups: ['self employed'],
    sector: {},
  },
  {
    ...
    category: ['research', 'mentoring', 'Finding out about work', 'Preparing for work'],
    groups: ['self employed'],
    sector: {},
  },
  {
